...
APIs (13 categories / ~62 services / 1,490 endpoints as of the 2026-09 spec bump
(search-index discovery, 2026-09-18) — trust `python -m spec.summary` over this number) on two axes (regression =
...
command to resume; (3) **pending tasks** — see the CURRENT block ("다음"/작업 큐)
in `docs/working/CONTEXT.md` + `data/coordination/ledger.json`; (4) any **open decision** not yet
