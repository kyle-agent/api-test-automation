...
Save to: `reports/token_audit/infographic.png`

Open with:
- macOS: `open reports/token_audit/infographic.png`
- Windows: `explorer.exe reports/token_audit/infographic.png`
...
2. **reports/token_audit/ directory** — create it if it doesn't exist before saving the infographic.
